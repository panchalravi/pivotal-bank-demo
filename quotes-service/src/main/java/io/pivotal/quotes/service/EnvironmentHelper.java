...
public class EnvironmentHelper {
    ...
    public Map<String, Object> addAppEnv(HttpServletRequest request)
      ...
      final Map vcapApplicationMap = getVcapApplicationMap();
      String instanceIndex = vcapApplicationMap.getOrDefault(
        ...
        String applicationName = (String) vcapApplicationMap.getOrDefault(
